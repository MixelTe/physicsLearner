...
function TR(classes?: string[] | string, children?: HTMLElement[], storeArray?: any[], index?: number)
{
	return initEl("tr", classes, children, undefined, storeArray, index);
}
function TD(classes?: string[] | string, children?: HTMLElement[], storeArray?: any[], index?: number)
{
